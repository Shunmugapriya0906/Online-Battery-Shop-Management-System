...
<html>
    ...
    <body>       
        ...
        <hr>
        <center>
            <p style="color:blueviolet;font-size:30px"> Welcome <?php echo $customerName;?> !!</p> <br>
            <p>Browse... Select...Order...</p><br>                        
            <img src="./images/img05.jpg" width="400" height="200"><br>
    <?php 
    if($dispError) {
    ?>
    ...
    ?>
            <table border="0">        
                <tr>
                    ...
                    <th style="border-right: solid 3px violet"></th>                    
                </tr>
                <tr> <td colspan="10"></td></tr>
                    
    <?php
        for($i=0;$i<$batteryCnt;$i++) {
            $link='confirmOrder.php?BId='.$arrBatteries[$i]['BId'];        
    ?>                
                <tr >
                    ...
                    <td style="border-right: solid 3px violet;text-align: center;border-bottom: dashed 2px violet"> <a href="<?php echo $link;?>"> Order </a> </td>                                            
                </tr>                
    <?php    
        }
    }
